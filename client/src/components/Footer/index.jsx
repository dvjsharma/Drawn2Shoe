                ...
                <div className="flex items-center  w-[20%] gap-3 my-3 justify-end max-lg:justify-center">
                    ...
                    >
                        <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-twitter-x transition-all hover:scale-105 duration-500 ease-in-out"
                            viewBox="0 0 16 16"
                        >
                    ...
                    >
                        <svg
                            ...
                            role="img"
                            viewBox="0 0 24 24"
                            className="icon h-[1rem] transition-all hover:scale-105 duration-500 ease-in-out"
                        >
                    ...
                    >
                        <svg
                            ...
                            height="20"
                            fill="currentColor"
                            className="bi bi-github transition-all hover:scale-105 duration-500 ease-in-out"
                            viewBox="0 0 16 16"
                        >
