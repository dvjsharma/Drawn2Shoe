    ...
    <div className='flex items-center justify-center w-full flex-col'>
        <div className='flex items-center justify-center w-[80%] flex-wrap min-h-[6rem] max-lg:flex-col font-bold'>
            ...
            <div className='flex items-center  w-[20%] gap-3 my-3 justify-end max-lg:justify-center'>
                <a href="https://twitter.com/drawn2shoe61810" target="_blank">
                ...
                <a href="https://www.facebook.com/profile.php?id=100091869992851" target="_blank">
                ...
                <a href="https://www.instagram.com/drawn2shoe/" target="_blank">
                ...
                <a href="https://github.com/dvjsharma/Drawn2Shoe" target="_blank" >
